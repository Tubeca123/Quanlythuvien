...
<!-- END SIDEBAR-->
           ...
           <div class="page-heading">
               <h1 class="page-title">Danh sách menu</h1>
               <ol class="breadcrumb">
           ...
           <div class="page-content fade-in-up">
               <div class="ibox">
                   <a class="btn btn-success"  target="_blank">Thêm mới</a>
                   <div class="ibox-body">
                       <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                           ...
                           <tbody>
                               ...
                               <tr id="row_{{ $mn->Id }}" >
                                   ...
                                   <td>
                                        <a  class="btn btn-default btn-xs m-r-5" data-toggle="tooltip" data-original-title="Sửa" >
