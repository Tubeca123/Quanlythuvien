...
<div class="page-heading">
    <h1 class="page-title">Danh sách phiếu đã hủy </h1>
    <ol class="breadcrumb">
                ...
                <tbody>
                    ...
                    <tr id="row_{{ $brr->Id }}">
                        ...
                        <td>
                            ...
                            <a class="btn btn-danger btn-sm btn-close1" data-id="{{ $brr->Id }}" title="Hủy phiếu mượn">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('body').on('click', '.btn-close1', function() {
